...
access(all) contract Fish: NonFungibleToken {
    ...
    access(all) resource NFT: NonFungibleToken.NFT {
        ...
        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-Fish.createEmptyCollection(nftType: Type<@Fish.NFT>())
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return Fish.resolveContractView(resourceType: Type<@Fish.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return Fish.resolveContractView(resourceType: Type<@Fish.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                ...
                case Type<MetadataViews.EVMBridgedMetadata>():
                    ...
                    let contractLevel = Fish.resolveContractView(
                            resourceType: nil,
    ...
    access(all) resource interface FishCollectionPublic {}

    access(all) resource Collection: NonFungibleToken.Collection, FishCollectionPublic {
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@Fish.NFT>()] = true
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            ...
            Fish.emitNFTUpdated(authTokenRef)
        }
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&Fish.Collection>(),
                    publicLinkedType: Type<&Fish.Collection>(),
    ...
    init() {
        ...
        // Set the named paths
        self.CollectionStoragePath = /storage/FishCollection
        self.CollectionPublicPath = /public/FishCollection
        self.MinterStoragePath = /storage/FishMinter
        ...
        let collectionCap = self.account.capabilities.storage.issue<&Fish.Collection>(self.CollectionStoragePath)
