...
access(all) contract SmallmouthBassCoin: FungibleToken {
    ...
    access(all) resource interface SpeciesCoinPublic {
        ...
        access(all) fun redeemCatchNFT(fishData: {String: AnyStruct}, angler: Address): @SmallmouthBassCoin.Vault
    }
        ...
        switch viewType {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    ...
                    receiverLinkedType: Type<&SmallmouthBassCoin.Vault>(),
                    metadataLinkedType: Type<&SmallmouthBassCoin.Vault>(),
                    createEmptyVaultFunction: (fun(): @{FungibleToken.Vault} {
                        return <-SmallmouthBassCoin.createEmptyVault(vaultType: Type<@SmallmouthBassCoin.Vault>())
                    })
                )
    ...
    access(all) resource FishDEXCoordinator: SpeciesCoinPublic {
        ...
        access(all) view fun getSpeciesCode(): String {
            return SmallmouthBassCoin.speciesMetadata.speciesCode
        }
        
        access(all) view fun getTicker(): String {
            return SmallmouthBassCoin.speciesMetadata.ticker
        }
        
        access(all) view fun getCommonName(): String {
            return SmallmouthBassCoin.speciesMetadata.commonName
        }
        
        access(all) view fun getScientificName(): String {
            return SmallmouthBassCoin.speciesMetadata.scientificName
        }
        
        access(all) view fun getFamily(): String {
            return SmallmouthBassCoin.speciesMetadata.family
        }
        
        access(all) view fun getTotalSupply(): UFix64 {
            return SmallmouthBassCoin.totalSupply
        }
        ...
        access(all) view fun getBasicRegistryInfo(): {String: AnyStruct} {
            return {
                ...
                "contractAddress": SmallmouthBassCoin.account.address,
                "dataYear": SmallmouthBassCoin.speciesMetadata.dataYear,
                "conservationStatus": SmallmouthBassCoin.speciesMetadata.globalConservationStatus,
                "rarityTier": SmallmouthBassCoin.speciesMetadata.rarityTier,
                "isRegistered": SmallmouthBassCoin.isRegisteredWithFishDEX
            }
        }
        ...
        access(all) fun redeemCatchNFT(fishData: {String: AnyStruct}, angler: Address): @SmallmouthBassCoin.Vault {
            ...
            if let nftId = fishNFTId {
                assert(
                    SmallmouthBassCoin.fishNFTRegistry[nftId] == nil,
                    message: "This NFT has already been redeemed for a coin"
                )
                // Record this NFT as redeemed
                SmallmouthBassCoin.fishNFTRegistry[nftId] = true
            }
            
            // Auto-record first catch if this is the very first mint
            if SmallmouthBassCoin.totalSupply == 0.0 && SmallmouthBassCoin.speciesMetadata.firstCatchDate == nil {
                SmallmouthBassCoin.speciesMetadata.setFirstCatchDate(UInt64(getCurrentBlock().timestamp))
            ...
            SmallmouthBassCoin.totalSupply = SmallmouthBassCoin.totalSupply + amount
        ...
        access(all) fun registerWithFishDEX(fishDEXAddress: Address) {
            pre {
                !SmallmouthBassCoin.isRegisteredWithFishDEX: "Already registered with FishDEX"
            }
            ...
            SmallmouthBassCoin.fishDEXAddress = fishDEXAddress
            SmallmouthBassCoin.isRegisteredWithFishDEX = true
        ...
        access(all) fun updateFishDEXAddress(newAddress: Address) {
            let oldAddress = SmallmouthBassCoin.fishDEXAddress
            SmallmouthBassCoin.fishDEXAddress = newAddress
            SmallmouthBassCoin.isRegisteredWithFishDEX = false // Reset registration status
    ...
    access(all) resource Vault: FungibleToken.Vault {
        ...
        access(contract) fun burnCallback() {
            if self.balance > 0.0 {
                SmallmouthBassCoin.totalSupply = SmallmouthBassCoin.totalSupply - self.balance
        ...
        access(all) view fun getViews(): [Type] {
            return SmallmouthBassCoin.getContractViews(resourceType: nil)
        }

        access(all) fun resolveView(_ view: Type): AnyStruct? {
            return SmallmouthBassCoin.resolveContractView(resourceType: nil, viewType: view)
        }

        access(all) view fun getSupportedVaultTypes(): {Type: Bool} {
            return {Type<@SmallmouthBassCoin.Vault>(): true}
        }

        access(all) view fun isSupportedVaultType(type: Type): Bool {
            return type == Type<@SmallmouthBassCoin.Vault>()
        }
        ...
        access(FungibleToken.Withdraw) fun withdraw(amount: UFix64): @SmallmouthBassCoin.Vault {
            self.balance = self.balance - amount
            return <-create Vault(balance: amount)
        }

        access(all) fun deposit(from: @{FungibleToken.Vault}) {
            let vault <- from as! @SmallmouthBassCoin.Vault
            self.balance = self.balance + vault.balance
            vault.balance = 0.0
            destroy vault
        }

        access(all) fun createEmptyVault(): @SmallmouthBassCoin.Vault {
    ...
    access(all) resource Minter {
        ...
        access(all) fun mintForCatch(amount: UFix64, fishId: UInt64, angler: Address): @SmallmouthBassCoin.Vault {
            pre {
                amount == 1.0: "Only 1 coin per verified catch"
                SmallmouthBassCoin.fishNFTRegistry[fishId] == nil: "This NFT has already been used to mint a coin"
            }
            
            // Record this NFT as used
            SmallmouthBassCoin.fishNFTRegistry[fishId] = true
        ...
        access(all) fun autoRegisterWithFishDEX() {
            if let fishDEXAddr = SmallmouthBassCoin.fishDEXAddress {
                if !SmallmouthBassCoin.isRegisteredWithFishDEX {
                    // Get reference to FishDEX coordinator
                    if let coordinatorRef = SmallmouthBassCoin.account.capabilities.borrow<&FishDEXCoordinator>(
                        SmallmouthBassCoin.FishDEXCoordinatorPublicPath
                    ) {
        ...
        access(all) fun mintBatch(recipients: {Address: UFix64}): @{Address: SmallmouthBassCoin.Vault} {
            let vaults: @{Address: SmallmouthBassCoin.Vault} <- {}
    ...
    access(all) resource MetadataAdmin {
        ...
        access(all) fun updateImageURL(newURL: String) {
            let oldURL = SmallmouthBassCoin.speciesMetadata.imageURL ?? ""
            SmallmouthBassCoin.speciesMetadata.setImageURL(newURL)
        ...
        access(all) fun updateDescription(newDescription: String) {
            let oldDescription = SmallmouthBassCoin.speciesMetadata.description
            SmallmouthBassCoin.speciesMetadata.setDescription(newDescription)
        ...
        access(all) fun updateHabitat(newHabitat: String) {
            let oldHabitat = SmallmouthBassCoin.speciesMetadata.habitat ?? ""
            SmallmouthBassCoin.speciesMetadata.setHabitat(newHabitat)
        ...
        access(all) fun updateAverageWeight(newWeight: UFix64) {
            let oldWeight = SmallmouthBassCoin.speciesMetadata.averageWeight?.toString() ?? "0.0"
            SmallmouthBassCoin.speciesMetadata.setAverageWeight(newWeight)
        ...
        access(all) fun updateAverageLength(newLength: UFix64) {
            let oldLength = SmallmouthBassCoin.speciesMetadata.averageLength?.toString() ?? "0.0"
            SmallmouthBassCoin.speciesMetadata.setAverageLength(newLength)
        ...
        access(all) fun updateRarityTier(newTier: UInt8) {
            ...
            let oldTier = SmallmouthBassCoin.speciesMetadata.rarityTier?.toString() ?? "0"
            SmallmouthBassCoin.speciesMetadata.setRarityTier(newTier)
        ...
        access(all) fun manuallySetFirstCatch(timestamp: UInt64, angler: Address) {
            pre {
                SmallmouthBassCoin.speciesMetadata.firstCatchDate == nil: "First catch already recorded"
            }
            SmallmouthBassCoin.speciesMetadata.setFirstCatchDate(timestamp)
        ...
        access(all) fun updateConservationStatus(newStatus: String) {
            let oldStatus = SmallmouthBassCoin.speciesMetadata.globalConservationStatus ?? ""
            SmallmouthBassCoin.speciesMetadata.setConservationStatus(newStatus)
        ...
        access(all) fun updateNativeRegions(newRegions: [String]) {
            var oldRegionsStr = "["
            for i, region in SmallmouthBassCoin.speciesMetadata.nativeRegions {
                if i > 0 { oldRegionsStr = oldRegionsStr.concat(",") }
                oldRegionsStr = oldRegionsStr.concat(region)
            }
            oldRegionsStr = oldRegionsStr.concat("]")
            
            SmallmouthBassCoin.speciesMetadata.setNativeRegions(newRegions)
        ...
        access(all) fun updateSeasonalPatterns(newPatterns: String) {
            let oldPatterns = SmallmouthBassCoin.speciesMetadata.seasonalPatterns ?? ""
            SmallmouthBassCoin.speciesMetadata.setSeasonalPatterns(newPatterns)
        ...
        access(all) fun updateRecordWeight(newRecord: UFix64) {
            let oldRecord = SmallmouthBassCoin.speciesMetadata.recordWeight?.toString() ?? "0.0"
            SmallmouthBassCoin.speciesMetadata.setRecordWeight(newRecord)
        ...
        access(all) fun updateRecordLength(newRecord: UFix64) {
            let oldRecord = SmallmouthBassCoin.speciesMetadata.recordLength?.toString() ?? "0.0"
            SmallmouthBassCoin.speciesMetadata.setRecordLength(newRecord)
        ...
        access(all) fun updateRecordWeightLocation(newLocation: String?) {
            let oldLocation = SmallmouthBassCoin.speciesMetadata.recordWeightLocation ?? ""
            SmallmouthBassCoin.speciesMetadata.setRecordWeightLocation(newLocation)
        ...
        access(all) fun updateRecordWeightDate(newDate: String?) {
            let oldDate = SmallmouthBassCoin.speciesMetadata.recordWeightDate ?? ""
            SmallmouthBassCoin.speciesMetadata.setRecordWeightDate(newDate)
        ...
        access(all) fun updateRecordLengthLocation(newLocation: String?) {
            let oldLocation = SmallmouthBassCoin.speciesMetadata.recordLengthLocation ?? ""
            SmallmouthBassCoin.speciesMetadata.setRecordLengthLocation(newLocation)
        ...
        access(all) fun updateRecordLengthDate(newDate: String?) {
            let oldDate = SmallmouthBassCoin.speciesMetadata.recordLengthDate ?? ""
            SmallmouthBassCoin.speciesMetadata.setRecordLengthDate(newDate)
        ...
        access(all) fun approvePendingUpdate(index: Int) {
            pre {
                index >= 0 && index < SmallmouthBassCoin.pendingUpdates.length: "Invalid update index"
            }
            let update = SmallmouthBassCoin.pendingUpdates.remove(at: index)
        ...
        access(all) fun rejectPendingUpdate(index: Int) {
            ...
            SmallmouthBassCoin.pendingUpdates.remove(at: index)
        }
        
        access(all) fun clearAllPendingUpdates() {
            SmallmouthBassCoin.pendingUpdates = []
        }
        
        // ENHANCED ADMIN FUNCTIONS WITH VALIDATION
        access(all) fun updateRarityTierValidated(newTier: UInt8) {
            pre {
                SmallmouthBassCoin.validateRating(newTier): "Invalid rarity tier (must be 1-10)"
            }
            let oldTier = SmallmouthBassCoin.speciesMetadata.rarityTier?.toString() ?? "0"
            SmallmouthBassCoin.speciesMetadata.setRarityTier(newTier)
            emit MetadataUpdated(field: "rarityTier", oldValue: oldTier, newValue: newTier.toString())
        ...
        access(all) fun updateConservationStatusValidated(newStatus: String) {
            pre {
                SmallmouthBassCoin.validateConservationStatus(newStatus): "Invalid conservation status"
            }
            let oldStatus = SmallmouthBassCoin.speciesMetadata.globalConservationStatus ?? ""
            SmallmouthBassCoin.speciesMetadata.setConservationStatus(newStatus)
            emit MetadataUpdated(field: "globalConservationStatus", oldValue: oldStatus, newValue: newStatus)
        ...
        access(all) fun updateFightRatingValidated(newRating: UInt8) {
            pre {
                SmallmouthBassCoin.validateRating(newRating): "Fight rating must be 1-10"
            }
            let oldRating = SmallmouthBassCoin.speciesMetadata.fightRating?.toString() ?? "0"
            SmallmouthBassCoin.speciesMetadata.setFightRating(newRating)
        ...
        access(all) fun archiveCurrentYear() {
            let currentYear = SmallmouthBassCoin.currentMetadataYear
            SmallmouthBassCoin.metadataHistory[currentYear] = SmallmouthBassCoin.speciesMetadata
            emit YearlyMetadataCreated(year: currentYear)
        }
        
        access(all) fun updateToNewYear(_ newYear: UInt64) {
            pre {
                newYear > SmallmouthBassCoin.currentMetadataYear: "New year must be greater than current year"
            }
            // Archive current year data
            self.archiveCurrentYear()
            
            let oldYear = SmallmouthBassCoin.currentMetadataYear
            SmallmouthBassCoin.currentMetadataYear = newYear
            emit MetadataYearUpdated(oldYear: oldYear, newYear: newYear)
        }
    }

    // Public functions
    access(all) fun createEmptyVault(vaultType: Type): @SmallmouthBassCoin.Vault {
        pre {
            vaultType == Type<@SmallmouthBassCoin.Vault>(): "Vault type mismatch"
        }
        return <-create Vault(balance: 0.0)
    }
    ...
    // NOTE: SmallmouthBass coins represent permanent historical catch records
    ...
    access(all) view fun getVaultBalance(vaultRef: &SmallmouthBassCoin.Vault): UFix64 {
        return vaultRef.balance
    }
    
    access(all) view fun canWithdraw(vaultRef: &SmallmouthBassCoin.Vault, amount: UFix64): Bool {
    ...
    access(all) view fun isValidVaultType(vaultType: Type): Bool {
        return vaultType == Type<@SmallmouthBassCoin.Vault>()
    }
    ...
    init() {
        ...
        self.speciesMetadata = SpeciesMetadata(
            // IMMUTABLE CORE FIELDS
            speciesCode: "MICROPTERUS_DOLOMIEU",
            ticker: "MICDOL",
            ...
            habitat: "Rocky lakes, rivers, streams with clear water and gravel substrate",
            averageWeight: 2.5,
            averageLength: 15.0,
            imageURL: "https://derby.fish/images/species/SmallmouthBass.jpg",
            description: "Smallmouth Bass are prized freshwater gamefish known for their aggressive fighting ability and aerial displays. They prefer clear, cool waters with rocky structure and are considered pound-for-pound the best fighting freshwater fish.",
            firstCatchDate: nil,
            rarityTier: 3,
            ...
            regionalPopulations: {
                ...
                "Northeast Rivers": RegionalPopulation(
                    populationTrend: "Stable",
                    threats: ["Dam Construction", "Water Quality", "Temperature Changes"],
                    protectedAreas: ["Delaware Water Gap", "Adirondack Park"],
                    estimatedPopulation: nil
                ),
                "Tennessee River System": RegionalPopulation(
                    populationTrend: "Stable",
                    threats: ["Reservoir Management", "Water Quality", "Competition"],
                    protectedAreas: ["Tennessee River Reservoirs"],
                    estimatedPopulation: nil
                )
            },
            ...
            // BIOLOGICAL INTELLIGENCE
            lifespan: 16.0,
            diet: "Crayfish, minnows, insects, small fish, hellgrammites",
            predators: ["Northern Pike", "Muskellunge", "Large Trout", "Birds", "Humans"],
            temperatureRange: "50-80°F (optimal 60-70°F)",
            depthRange: "5-50 feet",
            spawningAge: 3.0,
            spawningBehavior: "Males build and guard circular nests in shallow rocky areas",
            migrationPattern: "Moves to deeper water in winter, shallow areas in spring and fall",
            waterQualityNeeds: "pH 6.5-8.0, high dissolved oxygen, clear water preferred",
            
            // GEOGRAPHIC & HABITAT
            nativeRegions: ["Eastern North America", "Great Lakes", "Ohio River Basin"],
            currentRange: ["Continental US", "Southern Canada", "Introduced worldwide"],
            waterTypes: ["Lake", "River", "Stream", "Reservoir"],
            ...
            tourismValue: 10,
            ecosystemRole: "Top Predator (smaller waters), Keystone Species",
            culturalSignificance: "State fish of Pennsylvania, icon of North American angling",
            
            // ANGLING & RECREATIONAL
            bestBaits: ["Tube jigs", "Crankbaits", "Spinnerbaits", "Soft plastics", "Live crayfish"],
            fightRating: 10,
            culinaryRating: 8,
            catchDifficulty: 6,
            seasonalAvailability: "Spring through fall, best in spring and fall",
            bestTechniques: ["Casting", "Jigging", "Drop shot", "Topwater", "Finesse fishing"],
            
            // REGULATORY
            regionalRegulations: {
                "Pennsylvania": RegionalRegulations(
                    sizeLimit: 12.0,
                    bagLimit: 5,
                    closedSeasons: [],
                ...
                "New York": RegionalRegulations(
                    sizeLimit: 10.0,
                    bagLimit: 5,
                    closedSeasons: ["December 1 - May 15"],
            ...
            // PHYSICAL & BEHAVIORAL
            physicalDescription: "Bronze-green body with vertical bars, red eyes, smaller mouth that doesn't extend past the eye",
            behaviorTraits: "Aggressive predator, structure-oriented, schooling behavior, excellent jumper",
            seasonalPatterns: "Shallow spawning in spring, deep water in summer, fall feeding migration",
            
            // RECORDS & ACHIEVEMENTS
            recordWeight: 11.15,
            recordWeightLocation: "Dale Hollow Lake, Tennessee",
            recordWeightDate: "July 9, 1955",
            recordLength: 27.0,
            recordLengthLocation: "Dale Hollow Lake, Tennessee",
            recordLengthDate: "July 9, 1955",
            
            // RESEARCH & SCIENTIFIC
            researchPriority: 7,
            geneticMarkers: "Population genetics and hybridization studies",
            studyPrograms: ["Great Lakes Fishery Commission", "Tennessee Wildlife Resources Agency", "Pennsylvania Fish and Boat Commission"],
            ...
            additionalMetadata: {
                ...
                "state_fish": "Pennsylvania",
                "nickname": "Bronzeback"
            }
        )

        // Set storage paths using common name format
        self.VaultStoragePath = /storage/SmallmouthBassCoinVault
        self.VaultPublicPath = /public/SmallmouthBassCoinReceiver
        self.MinterStoragePath = /storage/SmallmouthBassCoinMinter
        self.MetadataAdminStoragePath = /storage/SmallmouthBassCoinMetadataAdmin
        self.FishDEXCoordinatorStoragePath = /storage/SmallmouthBassCoinFishDEXCoordinator
        self.FishDEXCoordinatorPublicPath = /public/SmallmouthBassCoinFishDEXCoordinator
        ...
        let cap = self.account.capabilities.storage.issue<&SmallmouthBassCoin.Vault>(self.VaultStoragePath)
