...
access(all) contract SailfishCoin: FungibleToken {
    ...
    access(all) resource interface SpeciesCoinPublic {
        ...
        access(all) fun redeemCatchNFT(fishData: {String: AnyStruct}, angler: Address): @SailfishCoin.Vault
    }
        ...
        switch viewType {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    ...
                    receiverLinkedType: Type<&SailfishCoin.Vault>(),
                    metadataLinkedType: Type<&SailfishCoin.Vault>(),
                    createEmptyVaultFunction: (fun(): @{FungibleToken.Vault} {
                        return <-SailfishCoin.createEmptyVault(vaultType: Type<@SailfishCoin.Vault>())
                    })
                )
    ...
    access(all) resource FishDEXCoordinator: SpeciesCoinPublic {
        ...
        access(all) view fun getSpeciesCode(): String {
            return SailfishCoin.speciesMetadata.speciesCode
        }
        
        access(all) view fun getTicker(): String {
            return SailfishCoin.speciesMetadata.ticker
        }
        
        access(all) view fun getCommonName(): String {
            return SailfishCoin.speciesMetadata.commonName
        }
        
        access(all) view fun getScientificName(): String {
            return SailfishCoin.speciesMetadata.scientificName
        }
        
        access(all) view fun getFamily(): String {
            return SailfishCoin.speciesMetadata.family
        }
        
        access(all) view fun getTotalSupply(): UFix64 {
            return SailfishCoin.totalSupply
        }
        ...
        access(all) view fun getBasicRegistryInfo(): {String: AnyStruct} {
            return {
                ...
                "contractAddress": SailfishCoin.account.address,
                "dataYear": SailfishCoin.speciesMetadata.dataYear,
                "conservationStatus": SailfishCoin.speciesMetadata.globalConservationStatus,
                "rarityTier": SailfishCoin.speciesMetadata.rarityTier,
                "isRegistered": SailfishCoin.isRegisteredWithFishDEX
            }
        }
        ...
        access(all) fun redeemCatchNFT(fishData: {String: AnyStruct}, angler: Address): @SailfishCoin.Vault {
            ...
            if let nftId = fishNFTId {
                assert(
                    SailfishCoin.fishNFTRegistry[nftId] == nil,
                    message: "This NFT has already been redeemed for a coin"
                )
                // Record this NFT as redeemed
                SailfishCoin.fishNFTRegistry[nftId] = true
            }
            
            // Auto-record first catch if this is the very first mint
            if SailfishCoin.totalSupply == 0.0 && SailfishCoin.speciesMetadata.firstCatchDate == nil {
                SailfishCoin.speciesMetadata.setFirstCatchDate(UInt64(getCurrentBlock().timestamp))
            ...
            SailfishCoin.totalSupply = SailfishCoin.totalSupply + amount
        ...
        access(all) fun registerWithFishDEX(fishDEXAddress: Address) {
            pre {
                !SailfishCoin.isRegisteredWithFishDEX: "Already registered with FishDEX"
            }
            ...
            SailfishCoin.fishDEXAddress = fishDEXAddress
            SailfishCoin.isRegisteredWithFishDEX = true
        ...
        access(all) fun updateFishDEXAddress(newAddress: Address) {
            let oldAddress = SailfishCoin.fishDEXAddress
            SailfishCoin.fishDEXAddress = newAddress
            SailfishCoin.isRegisteredWithFishDEX = false // Reset registration status
    ...
    access(all) resource Vault: FungibleToken.Vault {
        ...
        access(contract) fun burnCallback() {
            if self.balance > 0.0 {
                SailfishCoin.totalSupply = SailfishCoin.totalSupply - self.balance
        ...
        access(all) view fun getViews(): [Type] {
            return SailfishCoin.getContractViews(resourceType: nil)
        }

        access(all) fun resolveView(_ view: Type): AnyStruct? {
            return SailfishCoin.resolveContractView(resourceType: nil, viewType: view)
        }

        access(all) view fun getSupportedVaultTypes(): {Type: Bool} {
            return {Type<@SailfishCoin.Vault>(): true}
        }

        access(all) view fun isSupportedVaultType(type: Type): Bool {
            return type == Type<@SailfishCoin.Vault>()
        }
        ...
        access(FungibleToken.Withdraw) fun withdraw(amount: UFix64): @SailfishCoin.Vault {
            self.balance = self.balance - amount
            return <-create Vault(balance: amount)
        }

        access(all) fun deposit(from: @{FungibleToken.Vault}) {
            let vault <- from as! @SailfishCoin.Vault
            self.balance = self.balance + vault.balance
            vault.balance = 0.0
            destroy vault
        }

        access(all) fun createEmptyVault(): @SailfishCoin.Vault {
    ...
    access(all) resource Minter {
        ...
        access(all) fun mintForCatch(amount: UFix64, fishId: UInt64, angler: Address): @SailfishCoin.Vault {
            pre {
                amount == 1.0: "Only 1 coin per verified catch"
                SailfishCoin.fishNFTRegistry[fishId] == nil: "This NFT has already been used to mint a coin"
            }
            
            // Record this NFT as used
            SailfishCoin.fishNFTRegistry[fishId] = true
        ...
        access(all) fun autoRegisterWithFishDEX() {
            if let fishDEXAddr = SailfishCoin.fishDEXAddress {
                if !SailfishCoin.isRegisteredWithFishDEX {
                    // Get reference to FishDEX coordinator
                    if let coordinatorRef = SailfishCoin.account.capabilities.borrow<&FishDEXCoordinator>(
                        SailfishCoin.FishDEXCoordinatorPublicPath
                    ) {
        ...
        access(all) fun mintBatch(recipients: {Address: UFix64}): @{Address: SailfishCoin.Vault} {
            let vaults: @{Address: SailfishCoin.Vault} <- {}
    ...
    access(all) resource MetadataAdmin {
        ...
        access(all) fun updateImageURL(newURL: String) {
            let oldURL = SailfishCoin.speciesMetadata.imageURL ?? ""
            SailfishCoin.speciesMetadata.setImageURL(newURL)
        ...
        access(all) fun updateDescription(newDescription: String) {
            let oldDescription = SailfishCoin.speciesMetadata.description
            SailfishCoin.speciesMetadata.setDescription(newDescription)
        ...
        access(all) fun updateHabitat(newHabitat: String) {
            let oldHabitat = SailfishCoin.speciesMetadata.habitat ?? ""
            SailfishCoin.speciesMetadata.setHabitat(newHabitat)
        ...
        access(all) fun updateAverageWeight(newWeight: UFix64) {
            let oldWeight = SailfishCoin.speciesMetadata.averageWeight?.toString() ?? "0.0"
            SailfishCoin.speciesMetadata.setAverageWeight(newWeight)
        ...
        access(all) fun updateAverageLength(newLength: UFix64) {
            let oldLength = SailfishCoin.speciesMetadata.averageLength?.toString() ?? "0.0"
            SailfishCoin.speciesMetadata.setAverageLength(newLength)
        ...
        access(all) fun updateRarityTier(newTier: UInt8) {
            ...
            let oldTier = SailfishCoin.speciesMetadata.rarityTier?.toString() ?? "0"
            SailfishCoin.speciesMetadata.setRarityTier(newTier)
        ...
        access(all) fun manuallySetFirstCatch(timestamp: UInt64, angler: Address) {
            pre {
                SailfishCoin.speciesMetadata.firstCatchDate == nil: "First catch already recorded"
            }
            SailfishCoin.speciesMetadata.setFirstCatchDate(timestamp)
        ...
        access(all) fun updateConservationStatus(newStatus: String) {
            let oldStatus = SailfishCoin.speciesMetadata.globalConservationStatus ?? ""
            SailfishCoin.speciesMetadata.setConservationStatus(newStatus)
        ...
        access(all) fun updateSeasonalPatterns(newPatterns: String) {
            let oldPatterns = SailfishCoin.speciesMetadata.seasonalPatterns ?? ""
            SailfishCoin.speciesMetadata.setSeasonalPatterns(newPatterns)
        ...
        access(all) fun updateRecordWeight(newRecord: UFix64) {
            let oldRecord = SailfishCoin.speciesMetadata.recordWeight?.toString() ?? "0.0"
            SailfishCoin.speciesMetadata.setRecordWeight(newRecord)
        ...
        access(all) fun updateRecordLength(newRecord: UFix64) {
            let oldRecord = SailfishCoin.speciesMetadata.recordLength?.toString() ?? "0.0"
            SailfishCoin.speciesMetadata.setRecordLength(newRecord)
        ...
        access(all) fun updateRecordWeightLocation(newLocation: String?) {
            let oldLocation = SailfishCoin.speciesMetadata.recordWeightLocation ?? ""
            SailfishCoin.speciesMetadata.setRecordWeightLocation(newLocation)
        ...
        access(all) fun updateRecordWeightDate(newDate: String?) {
            let oldDate = SailfishCoin.speciesMetadata.recordWeightDate ?? ""
            SailfishCoin.speciesMetadata.setRecordWeightDate(newDate)
        ...
        access(all) fun updateRecordLengthLocation(newLocation: String?) {
            let oldLocation = SailfishCoin.speciesMetadata.recordLengthLocation ?? ""
            SailfishCoin.speciesMetadata.setRecordLengthLocation(newLocation)
        ...
        access(all) fun updateRecordLengthDate(newDate: String?) {
            let oldDate = SailfishCoin.speciesMetadata.recordLengthDate ?? ""
            SailfishCoin.speciesMetadata.setRecordLengthDate(newDate)
        ...
        access(all) fun approvePendingUpdate(index: Int) {
            pre {
                index >= 0 && index < SailfishCoin.pendingUpdates.length: "Invalid update index"
            }
            let update = SailfishCoin.pendingUpdates.remove(at: index)
        ...
        access(all) fun rejectPendingUpdate(index: Int) {
            ...
            SailfishCoin.pendingUpdates.remove(at: index)
        }
        
        access(all) fun clearAllPendingUpdates() {
            SailfishCoin.pendingUpdates = []
        }
        
        // ENHANCED ADMIN FUNCTIONS WITH VALIDATION
        access(all) fun updateRarityTierValidated(newTier: UInt8) {
            pre {
                SailfishCoin.validateRating(newTier): "Invalid rarity tier (must be 1-10)"
            }
            let oldTier = SailfishCoin.speciesMetadata.rarityTier?.toString() ?? "0"
            SailfishCoin.speciesMetadata.setRarityTier(newTier)
            emit MetadataUpdated(field: "rarityTier", oldValue: oldTier, newValue: newTier.toString())
        ...
        access(all) fun updateConservationStatusValidated(newStatus: String) {
            pre {
                SailfishCoin.validateConservationStatus(newStatus): "Invalid conservation status"
            }
            let oldStatus = SailfishCoin.speciesMetadata.globalConservationStatus ?? ""
            SailfishCoin.speciesMetadata.setConservationStatus(newStatus)
            emit MetadataUpdated(field: "globalConservationStatus", oldValue: oldStatus, newValue: newStatus)
        ...
        access(all) fun updateFightRatingValidated(newRating: UInt8) {
            pre {
                SailfishCoin.validateRating(newRating): "Fight rating must be 1-10"
            }
            let oldRating = SailfishCoin.speciesMetadata.fightRating?.toString() ?? "0"
            SailfishCoin.speciesMetadata.setFightRating(newRating)
        ...
        access(all) fun archiveCurrentYear() {
            let currentYear = SailfishCoin.currentMetadataYear
            SailfishCoin.metadataHistory[currentYear] = SailfishCoin.speciesMetadata
            emit YearlyMetadataCreated(year: currentYear)
        }
        
        access(all) fun updateToNewYear(_ newYear: UInt64) {
            pre {
                newYear > SailfishCoin.currentMetadataYear: "New year must be greater than current year"
            }
            // Archive current year data
            self.archiveCurrentYear()
            
            let oldYear = SailfishCoin.currentMetadataYear
            SailfishCoin.currentMetadataYear = newYear
            emit MetadataYearUpdated(oldYear: oldYear, newYear: newYear)
        }
    }

    // Public functions
    access(all) fun createEmptyVault(vaultType: Type): @SailfishCoin.Vault {
        pre {
            vaultType == Type<@SailfishCoin.Vault>(): "Vault type mismatch"
        }
        return <-create Vault(balance: 0.0)
    }
    ...
    // NOTE: Sailfish coins represent permanent historical catch records
    ...
    access(all) view fun getVaultBalance(vaultRef: &SailfishCoin.Vault): UFix64 {
        return vaultRef.balance
    }
    
    access(all) view fun canWithdraw(vaultRef: &SailfishCoin.Vault, amount: UFix64): Bool {
    ...
    access(all) view fun isValidVaultType(vaultType: Type): Bool {
        return vaultType == Type<@SailfishCoin.Vault>()
    }
    ...
    init() {
        ...
        self.speciesMetadata = SpeciesMetadata(
            // IMMUTABLE CORE FIELDS
            speciesCode: "ISTIOPHORUS_PLATYPTERUS",
            ticker: "ISTPLA",
            ...
            averageWeight: 65.0,
            averageLength: 84.0,
            imageURL: "https://derby.fish/images/species/Sailfish.jpg",
            description: "Sailfish are iconic billfish known for their spectacular dorsal fin and incredible speed. They are considered the fastest fish in the ocean and are highly prized by sport fishermen for their acrobatic fights and stunning beauty.",
            firstCatchDate: nil,
            rarityTier: 5,
            ...
            regionalPopulations: {
                ...
                "Gulf of Mexico": RegionalPopulation(
                    populationTrend: "Stable",
                    threats: ["Commercial Longline Fishing", "Habitat Degradation"],
                    protectedAreas: ["Gulf Marine Sanctuaries"],
                    estimatedPopulation: nil
                ),
                "Caribbean Sea": RegionalPopulation(
                    populationTrend: "Stable",
                    threats: ["Overfishing", "Pollution", "Climate Change"],
                    protectedAreas: ["Caribbean Marine Parks"],
                    estimatedPopulation: nil
                )
            },
            ...
            // BIOLOGICAL INTELLIGENCE
            lifespan: 13.0,
            diet: "Small fish, squid, crustaceans, sardines, anchovies, mackerel",
            predators: ["Sharks", "Larger billfish", "Tuna", "Humans"],
            temperatureRange: "70-85°F (optimal 75-82°F)",
            depthRange: "0-600 feet",
            spawningAge: 2.0,
            spawningBehavior: "Spawns in warm oceanic waters, releases millions of eggs",
            migrationPattern: "Follows warm currents and baitfish migrations",
            waterQualityNeeds: "Clean oceanic water with high dissolved oxygen",
            
            // GEOGRAPHIC & HABITAT
            nativeRegions: ["Atlantic Ocean", "Gulf of Mexico", "Caribbean Sea"],
            currentRange: ["Western Atlantic", "Eastern Atlantic", "Mediterranean Sea"],
            ...
            tourismValue: 10,
            ecosystemRole: "Apex Predator (pelagic), Top Marine Predator",
            culturalSignificance: "Symbol of sport fishing excellence, Florida's state saltwater fish",
            
            // ANGLING & RECREATIONAL
            bestBaits: ["Live bait", "Ballyhoo", "Mullet", "Squid", "Artificial lures"],
            fightRating: 10,
            culinaryRating: 7,
            catchDifficulty: 9,
            seasonalAvailability: "Year-round in tropics, seasonal in temperate waters",
            bestTechniques: ["Trolling", "Kite fishing", "Live bait fishing", "Fly fishing", "Casting"],
            ...
            regionalRegulations: {
                "Florida": RegionalRegulations(
                    ...
                    bagLimit: 1,
                    closedSeasons: [],
                    specialRegulations: "Catch and release encouraged, circle hooks required",
                ...
                "Federal Waters": RegionalRegulations(
                    ...
                    bagLimit: 1,
                    closedSeasons: [],
                    specialRegulations: "HMS permit required",
                    licenseRequired: true
                ),
                "Caribbean": RegionalRegulations(
                    ...
                    bagLimit: 1,
                    closedSeasons: [],
                    specialRegulations: "Varies by country",
                    licenseRequired: true
                )
            },
            
            // PHYSICAL & BEHAVIORAL
            physicalDescription: "Bright blue back with silver sides, enormous dorsal fin (sail), long bill, streamlined body",
            behaviorTraits: "Extremely fast swimmer, acrobatic fighter, schooling behavior, surface feeder",
            seasonalPatterns: "Follows warm water and baitfish migrations",
            
            // RECORDS & ACHIEVEMENTS
            recordWeight: 141.0,
            recordWeightLocation: "Luanda, Angola",
            recordWeightDate: "February 5, 2014",
            recordLength: 135.0,
            recordLengthLocation: "Ecuador",
            recordLengthDate: "March 12, 2015",
            
            // RESEARCH & SCIENTIFIC
            researchPriority: 9,
            geneticMarkers: "Population structure and migration pattern studies",
            studyPrograms: ["NOAA Fisheries", "Billfish Foundation", "International Commission for Conservation of Atlantic Tunas"],
            ...
            additionalMetadata: {
                ...
                "state_fish": "Florida (saltwater)",
                "nickname": "Spindlebeak"
            }
        )

        // Set storage paths using common name format
        self.VaultStoragePath = /storage/SailfishCoinVault
        self.VaultPublicPath = /public/SailfishCoinReceiver
        self.MinterStoragePath = /storage/SailfishCoinMinter
        self.MetadataAdminStoragePath = /storage/SailfishCoinMetadataAdmin
        self.FishDEXCoordinatorStoragePath = /storage/SailfishCoinFishDEXCoordinator
        self.FishDEXCoordinatorPublicPath = /public/SailfishCoinFishDEXCoordinator
        ...
        let cap = self.account.capabilities.storage.issue<&SailfishCoin.Vault>(self.VaultStoragePath)
